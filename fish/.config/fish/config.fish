...
fish_add_path $PNPM_HOMEset -U PATH $PATH ~/anaconda3/bin

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
if test -f /home/daniele/anaconda3/bin/conda
    eval /home/daniele/anaconda3/bin/conda "shell.fish" "hook" $argv | source
else
    if test -f "/home/daniele/anaconda3/etc/fish/conf.d/conda.fish"
        . "/home/daniele/anaconda3/etc/fish/conf.d/conda.fish"
    else
        set -x PATH "/home/daniele/anaconda3/bin" $PATH
    end
end
# <<< conda initialize <<<
